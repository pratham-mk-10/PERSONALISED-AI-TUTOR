...
export const INTRO_STEPS = [
  { progress: 1 / 6, part: 1, text: "Welcome. Let us begin. Look at this diagram carefully. The top half represents air with refractive index one point zero zero. The bottom half, shaded in blue, represents water with refractive index one point three three. A higher refractive index means light travels more slowly. Light travels faster in air and slower in water. The horizontal line separating them is the boundary where refraction happens." },
  ...
  { progress: 4 / 6, part: 4, text: "At point P we draw a dotted line perpendicular to the surface. This is the Normal. All angles in refraction are measured from the Normal, never from the surface itself. The normal extends both above and below the boundary." },
